        ...
        child: BlocConsumer<Mycubit, Sellerstates>(
          ...
          builder: (context, state) {
            ...
            children: [
                ...
                Padding(
                  padding: const EdgeInsets.only(top: 3,right: 8,left: 8,bottom: 3),
                  child: Row(children: [ GestureDetector(
                    onTap: () {

                    },
                    child: Text('forget'.tr,style: TextStyle(color: Colors.blueAccent),),
                  )],),
                ),
                Container(
                  alignment: Alignment.center,
                  child: Buttonfi('logi'.tr, 55, 250, 20, Color(0xff010155),
                      Color(0xffffffff), () {
              ...
              Padding(
                ...
                child: Row(
                  ...
                  child: Text('signup'.tr,style: TextStyle(color: Colors.blueAccent,fontSize: 20),),
                )],),
              ),
